                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="website-tab">
                                ...
                                <!-- Form Start -->
                                <form class="needs-validation" novalidate action="{{ route($route . '.siteinfo') }}"
                                    ...
                                    <div class="form-group">
                                        <label for="title">Tag Line<span>*</span></label>
                                        <input type="text" class="form-control" name="tag_line" id="tag_line"
                                            value="{{ isset($row->tag_line) ? $row->tag_line : '' }}">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            @if (isset($row->logo_path))
                                                @if (is_file('uploads/' . $path . '/' . $row->logo_path))
                                                    <img src="{{ asset('uploads/' . $path . '/' . $row->logo_path) }}"
                                                        class="img-fluid site-image" alt="{{ __('dashboard.site_logo') }}">
                                                @endif
                                            @endif

                                            <label for="logo">{{ __('dashboard.site_logo') }}:
                                                <span>{{ __('dashboard.image_size', ['height' => 80, 'width' => 'Any']) }}</span></label>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            @if (isset($row->favicon_path))
                                                @if (is_file('uploads/' . $path . '/' . $row->favicon_path))
                                                    <img src="{{ asset('uploads/' . $path . '/' . $row->favicon_path) }}"
                                                        class="img-fluid site-image"
                                                        alt="{{ __('dashboard.site_favicon') }}">
                                                @endif
                                            @endif

                                            <label for="favicon">{{ __('dashboard.site_favicon') }}:
                                                <span>{{ __('dashboard.image_size', ['height' => 64, 'width' => 64]) }}</span></label>
                                        ...
                                        <div class="form-group col-md-6 mt-2">
                                            ...
                                            @if (isset($row->catalogue_path))
                                                @if (is_file('uploads/' . $path . '/' . $row->catalogue_path))
                                                    <img src="{{ asset('uploads/' . $path . '/' . $row->catalogue_path) }}"
                                                        class="img-fluid site-image"
                                                        alt="{{ __('dashboard.site_favicon') }}">
                                                @endif
                                            @endif

                                            <label for="favicon">Catalogue:
                                                <span>{{ __('dashboard.image_size', ['height' => 690, 'width' => 468]) }}</span></label>
                                            <input type="file" class="form-control" name="catalogue_path"
                                                id="catalogue_path">
                                        ...
                                        <div class="form-group col-md-6 mt-2">
                                            ...
                                            @if (isset($row->map_path))
                                                @if (is_file('uploads/' . $path . '/' . $row->map_path))
                                                    <img src="{{ asset('uploads/' . $path . '/' . $row->map_path) }}"
                                                        class="img-fluid site-image" alt="">
                                                @endif
                                            @endif

                                            <label for="favicon">Map Image:
                                                <span>{{ __('dashboard.image_size', ['height' => 690, 'width' => 500]) }}</span></label>
                                            <input type="file" class="form-control" name="map_path" id="map_path">
                                        ...
                                        <div class="form-group col-md-6 mt-2">
                                            <label for="pdf_upload">Upload Catalogue PDF:</label>
                                            <input type="file" class="form-control" name="pdf_path" id="pdf_path"
                                                accept="application/pdf">

                                            <div class="invalid-feedback">
                                                {{ __('dashboard.please_provide') }} {{ __('dashboard.pdf_file') }}
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6 mt-2">
                                            <label for="multiple_images">Our Certification(120*120px)</label>
                                            <input type="file" class="form-control"
                                                name="certification_multiple_images[]" id="certification_multiple_images"
                                                multiple>
                                            <div class="invalid-feedback">
                                                {{ __('dashboard.please_provide') }}
                                                {{ __('dashboard.certification_multiple_images') }}
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6 mt-2">
                                            <label for="multiple_images">Our Achievement(120*120)px</label>
                                            <input type="file" class="form-control"
                                                name="achievement_multiple_images[]" id="achievement_multiple_images"
                                                multiple>
                                            <div class="invalid-feedback">
                                                {{ __('dashboard.please_provide') }}
                                                {{ __('dashboard.achievement_multiple_images') }}
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane" id="contact-tab">
                                ...
                                <!-- Form Start -->
                                <form class="needs-validation" novalidate action="{{ route($route . '.contactinfo') }}"
                                    method="post" enctype="multipart/form-data">
                                    @csrf
                                    <input name="id" type="hidden" value="{{ isset($row->id) ? $row->id : -1 }}">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="phone_no" id="phone_no"
                                                value="{{ isset($row->phone_one) ? $row->phone_one : '' }}" required>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <label for="email_address">{{ __('dashboard.email_address_1') }}
                                                <span>*</span></label>
                                            <input type="email" class="form-control" name="email_address"
                                                id="email_address"
                                                value="{{ isset($row->email_one) ? $row->email_one : '' }}" required>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="email" class="form-control" name="email_address2"
                                                id="email_address2"
                                                value="{{ isset($row->email_two) ? $row->email_two : '' }}">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <label for="contact_address">{{ __('dashboard.contact_address') }}
                                                <span>*</span></label>
                                            <input type="text" class="form-control" name="contact_address"
                                                id="contact_address"
                                                value="{{ isset($row->contact_address) ? $row->contact_address : '' }}"
                                                required>
                                    ...
                                    <div class="form-group">
                                        <label for="office_hours">{{ __('dashboard.office_hours') }}
                                            <span>{{ __('dashboard.open_close_times') }}</span></label>
                                    ...
                                    <div class="form-group">
                                        <label for="google_map">{{ __('dashboard.google_map') }}
                                            <span>{{ __('dashboard.embed_code') }}</span> <a
                                                href="https://www.google.com/maps"
                                                target="_blank">{{ __('dashboard.google_map') }}</a></label>
                            ...
                            <div class="tab-pane" id="social-tab">
                                ...
                                <!-- Form Start -->
                                <form class="needs-validation" novalidate action="{{ route($route . '.socialinfo') }}"
                                    method="post" enctype="multipart/form-data">
                                    @csrf
                                    <input name="id" type="hidden"
                                        value="{{ isset($social->id) ? $social->id : -1 }}">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="url" class="form-control" name="pinterest" id="pinterest"
                                                value="{{ isset($social->pinterest) ? $social->pinterest : '' }}">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="skype" id="skype"
                                                value="{{ isset($social->skype) ? $social->skype : '' }}">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="whatsapp">{{ __('dashboard.whatsapp') }}
                                                <span>({{ __('dashboard.inc_country_code') }})</span></label>
                                            <input type="text" class="form-control" name="whatsapp" id="whatsapp"
                                                value="{{ isset($social->whatsapp) ? $social->whatsapp : '' }}">
                            ...
                            <div class="tab-pane" id="custom-tab">
                                ...
                                <!-- Form Start -->
                                <form class="needs-validation" novalidate action="{{ route($route . '.customcode') }}"
                                    method="post" enctype="multipart/form-data">
                                    @csrf
                                    <input name="id" type="hidden" value="{{ isset($row->id) ? $row->id : -1 }}">
                            ...
                            <div class="tab-pane" id="account-tab">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="needs-validation" novalidate
                                            action="{{ route($route . '.changemail') }}" method="post"
                                            enctype="multipart/form-data">
                                            @csrf

                                            <div class="form-group row">
                                                <label for="email"
                                                    class="col-md-4 col-form-label text-md-right">{{ __('dashboard.mail_address') }}
                                                    <span>*</span></label>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-6 offset-md-4">
                                                    <button type="submit"
                                                        class="btn btn-primary">{{ __('dashboard.change') }}</button>
                                                </div>
                                            </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <!-- Form Start -->
                                        <form class="needs-validation" novalidate
                                            action="{{ route($route . '.changepass') }}" method="post"
                                            enctype="multipart/form-data">
                                            @csrf

                                            <div class="form-group row">
                                                <label for="password"
                                                    class="col-md-4 col-form-label text-md-right">{{ __('dashboard.old_password') }}
                                                    <span>*</span></label>
                                            ...
                                            <div class="form-group row">
                                                <label for="password"
                                                    class="col-md-4 col-form-label text-md-right">{{ __('dashboard.new_password') }}
                                                    <span>*</span></label>
                                            ...
                                            <div class="form-group row">
                                                <label for="password-confirm"
                                                    class="col-md-4 col-form-label text-md-right">{{ __('dashboard.confirm_password') }}
                                                    <span>*</span></label>
