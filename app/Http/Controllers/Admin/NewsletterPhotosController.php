...
class NewsletterPhotosController extends Controller
{
    public function __construct()
    {
        // Module Data
        $this->title = trans_choice('dashboard.blog', 1);
        $this->route = 'admin.newsletter_photos';
        $this->view = 'admin.newsletter_photos';
        $this->path = 'newsletter_photos';
    }
    ...
    public function index()
    {
        ...
        $data['rows'] = NewsletterPhotos::orderBy('id', 'desc')->get();
    ...
    public function create()
    {
        ...
        $data['newsletter_photos'] = NewsletterPhotos::where('status', '1')->get();
    ...
    public function store(Request $request)
    {
        ...
        $newsletterPhoto = new NewsletterPhotos();
    ...
    public function show(NewsletterPhotos $article, $id)
    {
        //
        $data['title'] = $this->title;
        $data['route'] = $this->route;
    ...
    public function edit(NewsletterPhotos $newsletter_photo)
    {
        $data['title'] = $this->title;
        $data['route'] = $this->route;
        $data['view'] = $this->view;
    ...
    public function update(Request $request, NewsletterPhotos $newsletterPhoto)
    {
        // Validate the image input
        $request->validate([
    ...
    public function destroy(NewsletterPhotos $article, $id)
    {
        // Delete Data
